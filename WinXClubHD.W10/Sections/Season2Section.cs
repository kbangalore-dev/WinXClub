...
{
    public class Season2Section : Section<YouTubeSchema>
    {
		private YouTubeDataProvider _dataProvider;
		
		public Season2Section()
		{
        ...
        public override ListPageConfig<YouTubeSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<YouTubeSchema>
                {
                    ...
                    Page = typeof(Pages.Season2ListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.Season2DetailPage>(true);
                    }
                };
            }
        }
