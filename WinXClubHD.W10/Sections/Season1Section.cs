...
{
    public class Season1Section : Section<YouTubeSchema>
    {
		private YouTubeDataProvider _dataProvider;
		
		public Season1Section()
		{
        ...
        public override ListPageConfig<YouTubeSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<YouTubeSchema>
                {
                    ...
                    Page = typeof(Pages.Season1ListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.Season1DetailPage>(true);
                    }
                };
            }
        }
