//---------------------------------------------------------------------------
//
// <copyright file="Season3DetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class Season3DetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public Season3DetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new Season3Section());
