//---------------------------------------------------------------------------
//
// <copyright file="Season1DetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class Season1DetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public Season1DetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new Season1Section());
