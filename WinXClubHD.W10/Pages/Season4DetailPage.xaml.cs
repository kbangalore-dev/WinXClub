//---------------------------------------------------------------------------
//
// <copyright file="Season4DetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class Season4DetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public Season4DetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new Season4Section());
