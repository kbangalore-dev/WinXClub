//---------------------------------------------------------------------------
//
// <copyright file="Season6DetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class Season6DetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public Season6DetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new Season6Section());
