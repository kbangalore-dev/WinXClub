//---------------------------------------------------------------------------
//
// <copyright file="Season7DetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class Season7DetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public Season7DetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new Season7Section());
