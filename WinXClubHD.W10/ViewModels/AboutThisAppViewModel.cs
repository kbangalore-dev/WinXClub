...
namespace WinXClubHD.ViewModels
{
    public class AboutThisAppViewModel : PageViewModelBase
    {
		public AboutThisAppViewModel()
        {
            ...
            this.AboutText = "Embark on a fantasy adventure with Bloom, Stella, Flora, Musa, Tecna and Aisha, t" +
    "he Winx Club! a special group of friends with strength, beauty, and magic in the" +
    "ir wings!  Watch all Seasons on HD!";
